...
static const tfrl_env_ops ENVS[] = {
    ...
    {
        .name = "arkanoid",
        .kind = TFRL_ENV_ARKANOID,
        .agent_count = 1,
        .spec = tfrl_env_spec_arkanoid,
        .reset = tfrl_env_reset_arkanoid,
        .step = tfrl_env_step_arkanoid,
        .step_multi = NULL,
        .render_bytes = tfrl_env_render_bytes_arkanoid,
        .render_write = tfrl_env_render_write_arkanoid,
    },
    {
        .name = "arkanoid_disc",
        .kind = TFRL_ENV_ARKANOID,
        .agent_count = 1,
        .spec = tfrl_env_spec_arkanoid_disc,
        .reset = tfrl_env_reset_arkanoid_disc,
        .step = tfrl_env_step_arkanoid_disc,
        .step_multi = NULL,
        .render_bytes = tfrl_env_render_bytes_arkanoid,
        .render_write = tfrl_env_render_write_arkanoid,
    },
    {
        .name = "breakout",
        .kind = TFRL_ENV_BREAKOUT,
        .agent_count = 1,
        .spec = tfrl_env_spec_breakout,
        .reset = tfrl_env_reset_breakout,
        .step = tfrl_env_step_breakout,
        .step_multi = NULL,
        .render_bytes = tfrl_env_render_bytes_breakout,
        .render_write = tfrl_env_render_write_breakout,
    },
    {
        .name = "breakout_disc",
        .kind = TFRL_ENV_BREAKOUT,
        .agent_count = 1,
        .spec = tfrl_env_spec_breakout_disc,
        .reset = tfrl_env_reset_breakout_disc,
        .step = tfrl_env_step_breakout_disc,
        .step_multi = NULL,
        .render_bytes = tfrl_env_render_bytes_breakout,
        .render_write = tfrl_env_render_write_breakout,
    },
